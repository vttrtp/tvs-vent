...
bool GripCback::GetParamsForDraw(AcDbObjectId * pEntId, int &pGripNumber)
{
	pEntId=entId;
...
bool GripCback::SetParamsForDraw(AcDbObjectId * pEntId, int &pGripNumber)
{
	entId=pEntId;
						...
						int					 contextFlags)
{
	...
	SetParamsForDraw(entId,(int) *pthis);
