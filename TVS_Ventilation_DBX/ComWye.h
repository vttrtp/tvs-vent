...
//-----------------------------------------------------------------------------
//----- ComWye.h : Declaration of the CComWye
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
class ATL_NO_VTABLE CComWye : 
	...
	public IOPMPropertyExtensionImpl<CComWye>,
	public IOPMPropertyExpander,
	public IAcadEntityDispatchImpl<CComWye, &CLSID_ComWye, IComWye, &IID_IComWye, &LIBID_TVSTVS_Ventilation_DBXLib>
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_COMWYE)

	BEGIN_COM_MAP(CComWye)
		COM_INTERFACE_ENTRY(IComWye)
