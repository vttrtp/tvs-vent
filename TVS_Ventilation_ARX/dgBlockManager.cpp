...
//-----------------------------------------------------------------------------
IMPLEMENT_DYNAMIC(dgBlockManager, CAdUiBaseDialog)

BEGIN_MESSAGE_MAP(dgBlockManager, CAdUiBaseDialog)
	ON_MESSAGE(WM_ACAD_KEEPFOCUS, OnAcadKeepFocus)
	ON_WM_SHOWWINDOW()
	ON_BN_CLICKED(IDOK, &dgBlockManager::OnBnClickedOk)
END_MESSAGE_MAP()

//-----------------------------------------------------------------------------
dgBlockManager::dgBlockManager(CWnd *pParent /*=NULL*/, HINSTANCE hInstance /*=NULL*/) : CAdUiBaseDialog(dgBlockManager::IDD, pParent, hInstance) {
}

//-----------------------------------------------------------------------------
void dgBlockManager::DoDataExchange(CDataExchange *pDX) {
...
LRESULT dgBlockManager::OnAcadKeepFocus(WPARAM, LPARAM) {
	return (TRUE);
}

void dgBlockManager::OnShowWindow(BOOL bShow, UINT nStatus)
{
...
void dgBlockManager::OnBnClickedOk()
{
	for (int i = 0; i < blckList.specList.length(); i++)
	{
