...
//----- CTVSPropertyNameDyn
class ATL_NO_VTABLE CTVSPropertyNameDyn :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CTVSPropertyNameDyn, &CLSID_TVSPropertyNameDyn>,
	public ISupportErrorInfo,
	public IDispatchImpl<ITVSPropertyNameDyn, &IID_ITVSPropertyNameDyn, &LIBID_TVSTVS_Ventilation_ARXLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_TVSPROPERTYNameDYN)

	BEGIN_COM_MAP(CTVSPropertyNameDyn)
		COM_INTERFACE_ENTRY(ITVSPropertyNameDyn)
...
OBJECT_ENTRY_AUTO(__uuidof(TVSPropertyNameDyn), CTVSPropertyNameDyn)
//OPM_DYNPROP_OBJECT_ENTRY_AUTO(CTVSPropertyNameDyn, AcDbObject)
