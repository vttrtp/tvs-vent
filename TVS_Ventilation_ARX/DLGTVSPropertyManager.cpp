...
//-----------------------------------------------------------------------------
IMPLEMENT_DYNAMIC (DLGTVSPropertyManager, CAdUiBaseDialog)

BEGIN_MESSAGE_MAP(DLGTVSPropertyManager, CAdUiBaseDialog)
	ON_MESSAGE(WM_ACAD_KEEPFOCUS, OnAcadKeepFocus)
	ON_WM_SHOWWINDOW()
	ON_BN_CLICKED(IDOK, &DLGTVSPropertyManager::OnBnClickedOk)
END_MESSAGE_MAP()

//-----------------------------------------------------------------------------
DLGTVSPropertyManager::DLGTVSPropertyManager (CWnd *pParent /*=NULL*/, HINSTANCE hInstance /*=NULL*/) : CAdUiBaseDialog (DLGTVSPropertyManager::IDD, pParent, hInstance) {
}

//-----------------------------------------------------------------------------
void DLGTVSPropertyManager::DoDataExchange (CDataExchange *pDX) {
...
LRESULT DLGTVSPropertyManager::OnAcadKeepFocus (WPARAM, LPARAM) {
	return (TRUE) ;
}
...
void DLGTVSPropertyManager::OnShowWindow(BOOL bShow, UINT nStatus)
{
...
void DLGTVSPropertyManager::OnBnClickedOk()
{
	int i = 1;
	for (auto &row : propertySpec.rows)
	{
