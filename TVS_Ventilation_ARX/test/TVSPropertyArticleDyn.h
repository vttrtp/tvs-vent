...
class ATL_NO_VTABLE CTVSPropertyArticleDyn :
	...
	public CComCoClass<CTVSPropertyArticleDyn, &CLSID_TVSPropertyPositionDyn>,
	public ISupportErrorInfo,
	public IDispatchImpl<ITVSPropertyPositionDyn, &IID_ITVSPropertyPositionDyn, &LIBID_TVSTVS_Ventilation_ARXLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	//ITVSPropertyPositionDyn

};

OBJECT_ENTRY_AUTO(__uuidof(TVSPropertyPositionDyn), CTVSPropertyArticleDyn)
