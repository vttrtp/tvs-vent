...
//-----------------------------------------------------------------------------
//----- dgAllEdit.h : Declaration of the dgAllEdit
//-----------------------------------------------------------------------------
#pragma once
...
CButton fTapDown;
	...
	CString TapForm;
	CString TypeRoundTap;
	CString RadiusTypeRound;
	CString RadiusTypeRect;
	CString TapRadiusVariableParameter;
	CString TapRadiusConst;
	CString Swectangle;
	...
	/*void checked (CButton &master, CButton &slave);*/
