...
class ATL_NO_VTABLE CTVSPropertyArticleDyn :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CTVSPropertyArticleDyn, &CLSID_TVSPropertyArticleDyn>,
	public ISupportErrorInfo,
	public IDispatchImpl<ITVSPropertyArticleDyn, &IID_ITVSPropertyArticleDyn, &LIBID_TVSTVS_Ventilation_ARXLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_TVSPROPERTYArticleDYN)

	BEGIN_COM_MAP(CTVSPropertyArticleDyn)
		COM_INTERFACE_ENTRY(ITVSPropertyArticleDyn)
...
public:
	...
	//ITVSPropertyArticleDyn

};

OBJECT_ENTRY_AUTO(__uuidof(TVSPropertyArticleDyn), CTVSPropertyArticleDyn)
OPM_DYNPROP_OBJECT_ENTRY_AUTO(CTVSPropertyArticleDyn, AcDbObject)
